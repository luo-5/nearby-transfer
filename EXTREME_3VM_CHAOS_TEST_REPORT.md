...
| 节点 | 操作系统 | IP 地址 | 角色 | 状态 |
| :--- | :--- | :--- | :--- | :--- |
| **Ubuntu** | Ubuntu 24.04 (Linux x86_64) | `192.168.80.128` | 发送端 / 接收端 / WebDAV 服务端 | 🟢 正常 |
| **CentOS** | CentOS Stream 9 (Linux x86_64) | `192.168.80.130` | 发送端 / 接收端 / 压力测试端 | 🟢 正常 |
| **Windows VM** | Windows 10 (Win32 x86_64) | `192.168.80.129` | 发送端 / 接收端 / Windows 客户端 | 🟢 正常 |
| **宿主机** | Windows 11 | `192.168.80.1` | **Python/Paramiko 自动化调度中心** | 🟢 调度完成 |
